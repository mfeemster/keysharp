...
- Use stable strings for finite public choices, explicit mappings for internal enums, and useful Boolean predicates. Preserve AHK contracts; do not add enum objects or constant containers. Enum errors identify the invalid value and list the accepted choices through Keysharp's continuable error handling.
