...
namespace Rtf
{
	/// <summary>
	/// Gotten from.
	/// https://www.codeproject.com/Articles/38858/Line-Numbers-for-RichText-Control-in-C
	/// </summary>
	...
	public class LineNumbers_For_RichTextBox : System.Windows.Forms.Control
	{
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			var zTextToShow = "";
			var zReminderToShow = "";
			var zSF = new StringFormat();
			var zTextSize = default(SizeF);
			var zPen = new Pen(ForeColor);
			var zBrush = new SolidBrush(ForeColor);
			var zPoint = new Point(0, 0);
			var zItemClipRectangle = new Rectangle(0, 0, 0, 0);
			//   NOTE: The GraphicsPaths are only used for SeeThroughMode
			//   FillMode.Winding: combined outline ( Alternate: XOR'ed outline )
			var zGP_GridLines = new System.Drawing.Drawing2D.GraphicsPath(System.Drawing.Drawing2D.FillMode.Winding);
			var zGP_BorderLines = new System.Drawing.Drawing2D.GraphicsPath(System.Drawing.Drawing2D.FillMode.Winding);
			var zGP_MarginLines = new System.Drawing.Drawing2D.GraphicsPath(System.Drawing.Drawing2D.FillMode.Winding);
			var zGP_LineNumbers = new System.Drawing.Drawing2D.GraphicsPath(System.Drawing.Drawing2D.FillMode.Winding);
			var zRegion = new Region(base.ClientRectangle);
			...
			if (DesignMode == true)
			{
				...
				if (zReminderToShow.Length > 0)
				{
					...
					var zReminderRectangle = new Rectangle((int)(Width / 2 - zTextSize.Height / 2), (int)(Height / 2 - zTextSize.Width / 2), (int)(zTextSize.Height), (int)(zTextSize.Width));
			...
			if (zLNIs.Count > 0)
			{
				...
				for (var zA = 0; zA <= zLNIs.Count - 1; zA++)
				{
					// --- BackgroundGradient
					...
					if (zGridLines_Show == true)
					{
						...
						zGP_GridLines.AddRectangle(new Rectangle((int)(-zGridLines_Thickness),
												   ...
												   (int)(Width + zGridLines_Thickness * 2),
												   (int)(Height - zLNIs[zA].Rectangle.Y + zGridLines_Thickness)
																));
					...
					if (zLineNumbers_Show == true)
					{
						...
						switch (zLineNumbers_Alignment)
						{
							case ContentAlignment.TopLeft:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Left + Padding.Left + zLineNumbers_Offset.Width), (int)(zLNIs[zA].Rectangle.Top + Padding.Top + zLineNumbers_Offset.Height));
								break;

							case ContentAlignment.MiddleLeft:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Left + Padding.Left + zLineNumbers_Offset.Width), (int)(zLNIs[zA].Rectangle.Top + (zLNIs[zA].Rectangle.Height / 2) + zLineNumbers_Offset.Height - zTextSize.Height / 2));
								break;

							case ContentAlignment.BottomLeft:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Left + Padding.Left + zLineNumbers_Offset.Width), (int)(zLNIs[zA].Rectangle.Bottom - Padding.Bottom + 1 + zLineNumbers_Offset.Height - zTextSize.Height));
								break;

							case ContentAlignment.TopCenter:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Width / 2 + zLineNumbers_Offset.Width - zTextSize.Width / 2), (int)(zLNIs[zA].Rectangle.Top + Padding.Top + zLineNumbers_Offset.Height));
								break;
							...
							case ContentAlignment.BottomCenter:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Width / 2 + zLineNumbers_Offset.Width - zTextSize.Width / 2), (int)(zLNIs[zA].Rectangle.Bottom - Padding.Bottom + 1 + zLineNumbers_Offset.Height - zTextSize.Height));
								break;

							case ContentAlignment.TopRight:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Right - Padding.Right + zLineNumbers_Offset.Width - zTextSize.Width), (int)(zLNIs[zA].Rectangle.Top + Padding.Top + zLineNumbers_Offset.Height));
								break;

							case ContentAlignment.MiddleRight:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Right - Padding.Right + zLineNumbers_Offset.Width - zTextSize.Width), (int)(zLNIs[zA].Rectangle.Top + (zLNIs[zA].Rectangle.Height / 2) + zLineNumbers_Offset.Height - zTextSize.Height / 2));
								break;

							case ContentAlignment.BottomRight:
								zPoint = new Point((int)(zLNIs[zA].Rectangle.Right - Padding.Right + zLineNumbers_Offset.Width - zTextSize.Width), (int)(zLNIs[zA].Rectangle.Bottom - Padding.Bottom + 1 + zLineNumbers_Offset.Height - zTextSize.Height));
								break;
						}
			...
			var zP_Left = new Point(
				(int)(Math.Floor(zBorderLines_Thickness / 2)),
				(int)(Math.Floor(zBorderLines_Thickness / 2))
			);
			var zP_Right = new Point(
				(int)(Width - Math.Ceiling(zBorderLines_Thickness / 2)),
				(int)(Height - Math.Ceiling(zBorderLines_Thickness / 2))
			);
			// --- BorderLines
			...
			if (zMarginLines_Show == true && zMarginLines_Side > LineNumberDockSide.None)
			{
				...
				zP_Right = new Point((int)(Width + zMarginLines_Thickness), (int)(Height + zMarginLines_Thickness));
				...
				{
					e.Graphics.DrawLine(zPen, new Point(
											(int)(Width - Math.Ceiling(zMarginLines_Thickness / 2)), 0),
										new Point(
											(int)(Width - Math.Ceiling(zMarginLines_Thickness / 2)),
											(int)(Height - 1))
									   );
					zP_Right = new Point(
						(int)(Width - Math.Ceiling(zMarginLines_Thickness / 2)),
						(int)(Height + zMarginLines_Thickness)
					);
				}
		...
		private void Update_VisibleLineNumberItems()
		{
			...
			if (zAutoSizing == true)
				zAutoSizing_Size = new Size(TextRenderer.MeasureText(zLineNumbers_Format.Replace('0', 'W'), Font).Width, 0);
			...
			else
			{
				...
				var zTimeSpan = new TimeSpan(DateAndTime.Now.Ticks);
				var zPoint = new Point(0, 0);
				var zStartIndex = 0;
				var zSplitStartLine = 0;
				var zA = zParent.Text.Length - 1;
				// #########################
				//this.FindStartIndex(ref zStartIndex, ref zA, ref zPointInParent.Y);
				tmpY = zPointInParent.Y;
				FindStartIndex(ref zStartIndex, ref zA, ref tmpY);
				...
				for (zA = zSplitStartLine; zA <= zSplit.Length - 1; zA++)
				{
					...
					if (zPoint.Y + zParentInMe > Height)
