namespace Keysharp.Core
{
	...
	public static class Objects
	{
		...
		/// <summary>
		/// Throws an Error exception because this function has no meaning in Keysharp.
		/// </summary>
		/// <param name="obj">Ignored.</param>
		/// <returns>None</returns>
		/// <exception cref="Error">Throws an Error exception because this function has no meaning in Keysharp.</exception>
		...
		/// <exception cref="Error">Throws an Error exception if obj was not of type KeysharpObject.</exception>
		...
		/// <returns>An OwnPropsIterator object for obj.</returns>
		/// <exception cref="Error">Throws an Error exception if obj was not of type KeysharpObject.</exception>
