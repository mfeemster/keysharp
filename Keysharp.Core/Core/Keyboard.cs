namespace Keysharp.Core
{
	...
	public static class Keyboard
	{
		...
		public static long GetKeySC(object keyName) => GetKeyNamePrivate(keyName.As(), 1).Al();
		...
		public static long GetKeyVK(object keyName) => GetKeyNamePrivate(keyName.As(), 2).Al();
