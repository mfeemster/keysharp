...
namespace Keysharp.Core
{
	/*
	    ...
	    //public static TreeView DefaultTreeView
	    //{
	    //  get
	    //  {
	    ...
	    public static long TV_GetChild(long id)
	    {
	        ...
	        //
	        //var node = GuiHelper.TV_FindNode(tree, id);
	        return 0;// node == null ? 0 : node.Nodes.Count == 0 ? 0 : node.FirstNode.Handle.ToInt64();
	    }
	    ...
	    {
	        //var tree = DefaultTreeView;
	        return 0;// tree == null ? 0 : tree.Nodes.Count;
	    }
	    ...
	    public static long TV_GetNext(int id = 0, string mode = null)
	    {
	        ...
	        //}
	        //
	        //for (var i = id == 0 ? 0 : GuiHelper.TV_FindNode(tree, id).Index; i < tree.Nodes.Count; i++)
	        //{
	    ...
	    public static long TV_GetPrev(long id)
	    {
	        ...
	        //
	        //var node = GuiHelper.TV_FindNode(tree, id);
	        return 0;// node.PrevNode == null ? 0 : node.PrevNode.Handle.ToInt64();
	    }
	    ...
	    {
	        //var tree = DefaultTreeView;
	        return 0;// tree == null ? 0 : tree.SelectedNode == null ? 0 : tree.SelectedNode.Handle.ToInt64();
	    }
