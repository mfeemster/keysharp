...
namespace Keysharp.Core.Common
{
	...
	internal class MsgMonitorStruct
	{
		...
		// For maintainability.  Causes a compiler warning if MAX_THREADS_LIMIT > MAX_UCHAR.
		internal int instanceCount;

		internal bool isMethod;

		// Distinct from func.mInstances because the script might have called the function explicitly.
		...
		// v1.0.47: Support more than one thread.
