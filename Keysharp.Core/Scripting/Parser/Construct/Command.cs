	...
	public partial class Parser
	{
		private CodeMethodInvokeExpression ParseCommand(string code)
		{
			...
			if (parts.Length > 1 && parts[1].Length != 0)
			{
				...
				libMethods.TryGetValue(low, out var meth);//MATT
		...
		private string[] SplitCommandParameters(string code, bool[] exp = null)
		{
		...
		private string[] SplitCommandStatement(string code)
		{
			var i = 0;
			var d = false;
