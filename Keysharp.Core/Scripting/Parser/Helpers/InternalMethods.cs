namespace Keysharp.Scripting
{
	public partial class Parser
	{
		...
		{
			internal static MethodReference AddHotkey => new MethodReference(typeof(HotkeyDefinition), "AddHotkey");
			internal static MethodReference AddHotstring => new MethodReference(typeof(HotstringManager), "AddHotstring");
			internal static MethodReference CreateTrayMenu => new MethodReference(typeof(Script), "CreateTrayMenu");
			internal static MethodReference Dictionary => new MethodReference(typeof(Collections), "Dictionary");
			internal static MethodReference Exit => new MethodReference(typeof(Flow), "Exit");
			internal static MethodReference ExitApp => new MethodReference(typeof(Flow), "ExitApp");
			...
			internal static MethodReference Hotkey => new MethodReference(typeof(Keyboard), "Hotkey");
			internal static MethodReference Hotstring => new MethodReference(typeof(Keyboard), "Hotstring");
			...
			internal static MethodReference Loop => new MethodReference(typeof(Loops), "Loop");
			internal static MethodReference LoopFile => new MethodReference(typeof(Loops), "LoopFile");
			internal static MethodReference LoopParse => new MethodReference(typeof(Loops), "LoopParse");
			internal static MethodReference LoopRead => new MethodReference(typeof(Loops), "LoopRead");
#if WINDOWS
			...
			internal static MethodReference MultiStatement => new MethodReference(typeof(Script), "MultiStatement");
			...
			internal static MethodReference Send => new MethodReference(typeof(Keyboard), "Send");
			...
			internal static MethodReference WaitThreads => new MethodReference(typeof(Script), "WaitThreads");
		}
	}
}