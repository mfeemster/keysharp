...
public partial class MainParser : MainParserBase {
	...
	public ForInParametersContext forInParameters() {
		...
		try {
			...
			case WS:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 281749183545345L) != 0)) {
					{
					State = 797;
					assignable();
					}
	...
	public CatchProductionContext catchProduction() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==OpenParen || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2533548997230593L) != 0)) {
				{
				State = 1067;
				catchAssignable();
				State = 1071;
	...
	public CatchAssignableContext catchAssignable() {
		...
		try {
			...
			case 2:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2533548997230593L) != 0)) {
					{
					State = 1111;
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
	...
	public ClassPropertyNameContext classPropertyName() {
		...
		try {
			...
			case 2:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==Multiply || _la==BitAnd || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 281749183545345L) != 0)) {
					{
					State = 1304;
					formalParameterList();
					}
	...
	private static int[] _serializedATN = {
		...
		69,135,135,1,0,70,71,1,0,72,76,1,0,77,80,5,0,86,86,100,100,113,114,116,
		123,134,134,9,0,69,69,81,85,87,93,98,99,101,112,115,115,118,118,120,121,
		123,128,1,1,136,136,2382,0,220,1,0,0,0,2,223,1,0,0,0,4,247,1,0,0,0,6,268,
		...
		0,0,0,202,2074,1,0,0,0,204,2079,1,0,0,0,206,2081,1,0,0,0,208,2087,1,0,
		0,0,210,2089,1,0,0,0,212,2091,1,0,0,0,214,2093,1,0,0,0,216,217,3,2,1,0,
