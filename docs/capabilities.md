...
| Base32 | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Class methods Encode and Decode convert RFC 4648 Base32 text and raw bytes, including unpadded TOTP secrets. Windows verified; Linux and macOS unverified. |
| Base32.Decode() | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Decodes RFC 4648 Base32 to a Buffer; accepts lowercase and omitted padding, rejects malformed alphabet, padding and nonzero pad bits. Windows verified; Linux and macOS unverified. |
| Base32.Encode() | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Encodes a String, StringBuffer, Buffer or byte Array as uppercase padded RFC 4648 Base32. Windows verified; Linux and macOS unverified. |
...
| Crypt.Hmac() | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Computes HMAC with SHA1, SHA256, SHA384 or SHA512, accepting the same case-insensitive, hyphen-tolerant names as Hash. Returns uppercase hexadecimal; Hex.Decode converts the digest to a Buffer. A File Value is streamed and its position restored. Windows RFC vectors verified; Linux and macOS unverified. |
...
| Hex | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Class methods Encode and Decode convert hexadecimal text and raw bytes. Windows verified; Linux and macOS unverified. |
| Hex.Decode() | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Decodes an even number of hexadecimal digits to a Buffer. Accepts either letter case and empty text; invalid characters, whitespace, prefixes and odd lengths raise ValueError. Windows verified; Linux and macOS unverified. |
| Hex.Encode() | 🟢 Full | ⚪ Unknown | ⚪ Unknown | ⚪ Unknown | Encodes a String, StringBuffer, Buffer or byte Array as uppercase hexadecimal without separators or prefix. Windows verified; Linux and macOS unverified. |
