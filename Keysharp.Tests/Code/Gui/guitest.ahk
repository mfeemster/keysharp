...
;#endif
FileMenu.SetIcon("Script Icon", A_ScriptDir "\..\..\..\Keysharp.ico")
FileMenu.SetIcon("Suspend Icon", A_ScriptDir "\..\..\..\Keysharp_s.ico")
FileMenu.SetIcon("Pause Icon", A_ScriptDir "\..\..\..\Keysharp_p.ico")
...
TEST_HEADER := MyGui.Add("Text", "Section w300 h30","Keysharp GUI Tests")
TEST_HEADER.SetFont("s20")

; ┌────────────────────────────────────┐
; │  Add button to change header font  │
; └────────────────────────────────────┘
headerBtn := MyGui.Add("Button", "xp y+10", "Make header font larger Comic Sans MS")
headerBtn.SetFont("s8")
headerBtn.OnEvent("Click", ChangeFont)

; ┌──────────────────────────────┐
; │  Add button to restore font  │
; └──────────────────────────────┘
headerBtn2 := MyGui.Add("Button", "x+10 yp", "Restore header font")
headerBtn2.SetFont("s8")
headerBtn2.OnEvent("Click", ChangeFontBack)

; ┌───────────────────────────────────┐
; │  Add button to change background  │
; └───────────────────────────────────┘
bgBtn := MyGui.Add("Button", "x+10 yp", "Change GUI Backgroud")
bgBtn.SetFont("s8")
...
; └────────────────────────────────────┘
bgBtn2 := MyGui.Add("Button", "x+10 yp", "Restore GUI Backgroud")
bgBtn2.SetFont("s8")
...
gb1_TabOne := MyGui.Add("GroupBox", "Section xs y+10 w325 h815", "Tab One - Group One") ; 

; ┌──────────────────────────────────┐
; │  Listview testing                │
; │  Double-click activates tooltip  │
; └──────────────────────────────────┘
LV_Label := MyGui.Add("Text", "w300 xs+10 ys+20 h20","Create listview with tooltip - double-click row")
LV_Label.SetFont("cBlue s10")
; Create the ListView with two columns, Name and Size:
LV := MyGui.Add("ListView", "r15 w300 xs+10 y+5 BackgroundTeal", ["Name","Size (KB)"])
...
; └─────────────────────────────────────────────┘
InputBtn := MyGui.Add("Button", "xs+10 y+10", "Input Test")
InputBtn.SetFont("s8")
...
RadioText := MyGui.Add("Text", "w200 xs+10 y+10 h20", "Radio group tests")
RadioText.SetFont("cBlue s10")
RadioOne := MyGui.Add("Radio", "vMyRadioGroup Group", "Change header font (alternate).")
RadioOne.OnEvent("Click", ChangeFont)
RadioTwo := MyGui.Add("Radio",, "Restore header font (alternate)")
RadioTwo.OnEvent("Click", ChangeFontBack)
RadioThree := MyGui.Add("Radio",, "Please click me.")
...
CheckBoxText := MyGui.Add("Text", "xs+10 y+10 w200 h20", "Checkbox test")
CheckBoxText.SetFont("cBlue s10")
CheckBoxOne := MyGui.Add("CheckBox", "w200 xs+10 yp+20", "If this text is long, it will wrap automatically")
...
Menu_Label := MyGui.Add("Text", "w300 xs+10 y+10 h30","Press Win-Z to see popup menu")
Menu_Label.SetFont("cBlue s14")

checkBtn := MyGui.Add("Button", "xs+10 y+3", "ControlSetChecked")
...
menuStringBtn := MyGui.Add("Button", "xs+10 y+3", "Select menu by string")
...
;MyGui.UseGroup()
Tab.UseTab("First")
gb2_TabOne := MyGui.Add("GroupBox", "Section x350 ys w325 h815", "Tab One - Group Two") ; 

; ┌───────────────────────────────┐
; │  Tab One, Group Two controls  │
; └───────────────────────────────┘

g2Label1 := MyGui.Add("Text", "xs+10 ys+20 h20 w250 cBlue", "Click buttons to set and reset style")
g2Label1.SetFont("s10")
g2Label2 := MyGui.Add("Text", "xs+10 y+5", "Keep an eye on the title bar!")

g2Btn1 := MyGui.Add("Button", "xs+10 y+10", "Set")
g2Btn1.SetFont("s10 cBlue")
g2Btn2 := MyGui.Add("Button", "xs+100 yp", "Reset")
g2Btn2.SetFont("s10 cBlue")

g2Btn1.OnEvent("Click", Set_Style)
g2Btn2.OnEvent("Click", Reset_Style)

g2Label3 := MyGui.Add("Text", "xs+10 y+10 h20 w200 cBlue", "Click buttons to alter Edit style")
g2Label3.SetFont("s10")
g2Label4 := MyGui.Add("Text", "xs+10 y+5", "Uppercase - restrict or reset")

MyEdit2 := MyGui.Add("Edit", "xs+10 y+5 w300 h100")
HwndMyEdit := MyEdit2.Hwnd

g2Btn3 := MyGui.Add("Button", "xs+10 y+10", "Uppercase")
g2Btn3.SetFont("s8 cBlue")
g2Btn4 := MyGui.Add("Button", "xs+100 yp", "Unrestrict")
...
iniLabel := MyGui.Add("Text", "xs+10 y+5 cRed", "Click to read kstests.ini`nKey = PRIMATE2`nValue = BONOBO")
iniBtn1 := MyGui.Add("Button", "xs+220 yp", "Read INI")
iniBtn1.OnEvent("Click", ReadINI)
iniText := MyGui.Add("Text", "w100 xs+150 y+10", "")
iniEdit := MyGui.Add("Edit", "xs+10 y+10 w300 h180")
...
iniWriteBtn := MyGui.Add("Button", "xs+10 y+10", "Write INI")
iniWriteBtn.OnEvent("Click", WriteINI)
writeLabel := MyGui.Add("Text", "xs+100 yp cGreen", "Write and Re-Write`nChange case`nThen change back")
iniWriteEdit := MyGui.Add("Edit", "xs+10 y+10 w300 h180")
...
; └─────────────────────────────┘
gb1_TabTwo := MyGui.Add("GroupBox", "Section x20 y50 w325 h850", "Tab Two - Group One") ; 
;MyGui.UseGroup()
...
; │  Edit  │
; └────────┘
SecondEdit := MyGui.Add("Edit", "xs+10 ys+20 w300 h200")
SecondEditText := MyGui.Add("Text", "cBlue h15 w200", "ControlSetText Test")
SecondEditText.SetFont("s10")
...
EditHwndBtn := MyGui.Add("Button", "x+10 yp", "Show Edit Hwnd")
EditHwndBtn.OnEvent("Click", ShowEditHwnd)

; ┌────────────┐
; │  RichEdit  │
; └────────────┘
SecondRichEdit := MyGui.Add("Edit", "xs+10 y+10 w250 h150", "Try pasting rich text and/or images here!")
SecondRichEditText := MyGui.Add("Text", "cBlue h15 w200", "ControlSetText Test (RichEdit)")
SecondRichEditText.SetFont("s10")
RichEditBtn1 := MyGui.Add("Button", "xs+10 y+10", "Send Text to RichEdit")
...
RichEditBtn3 := MyGui.Add("Button", "xs+10 y+5", "Clear RichEdit")
...
; │  TreeView  │
; └────────────┘
TreeViewText := MyGui.Add("Text", "xs+10 y+10 cBlue w200", "TreeView Test")
TreeViewText.SetFont("s10")
...
; └──────────────────────────┘
MousePosText := MyGui.Add("Text", "xs+10 y+10 cBlue h15 w200", "Uses SetTimer to show mouse position")
MousePosText.SetFont("s10")
CoordText := MyGui.Add("Text", "xs+10 y+10 h20 cLime", "")
...
SrchPic := MyGui.Add("Picture", "xs+10 y+10 h-1", A_ScriptDir . A_DirSeparator . "killbill.png")
SrchPicText := MyGui.Add("Text", "xs+10 y+15 h15 w200", "^ Use top menu to find me!")
...
;MyGui.UseGroup()
Tab.UseTab("Second")
gb2_TabTwo := MyGui.Add("GroupBox", "Section x350 y50 w400 h600", "Tab Two - Group Two")
;MyGui.UseGroup(gb2_TabTwo)

; ┌─────────┐
; │  Edits  │
; └─────────┘
t2g2t1 := MyGui.Add("Text", "xs+10 ys+20 w200 cBlue", "Password entry")
t2g2t1.SetFont("s10")
...
numericText := MyGui.Add("Text", "xs+10 y+10 h15", "The text box below should be numeric only")
...
MoveText := MyGui.Add("Text", "xs+10 y+10 h15 w200", "Move window with this caption, or blank to move this window")
MoveText.SetFont("s10 cBlue")
MoveEdit := MyGui.Add("Edit", "w200 xp y+10", "")
;#if LINUX
;	MoveEdit.Text := "About Calculator"
;#endif
MoveGUIButton := MyGui.Add("Button", , "Move GUI")
MoveGUIButton.OnEvent("Focus", ChangeMoveBtnColor)
MoveGUIButton.OnEvent("Click", MoveGui)
MoveButtonBack := MyGui.Add("Button", "xs+120 yp", "Move GUI Back")
MoveButtonBack.OnEvent("Focus", ChangeMoveBtnBackColor)
MoveButtonBack.OnEvent("Click", MoveGuiBack)

ChangeMoveBtnColor(*) {
	MoveGUIButton.SetFont("cRed")
	MoveButtonBack.SetFont("cBlack")
}

ChangeMoveBtnBackColor(*) {
	MoveGUIButton.SetFont("cBlack")
...
TitleInfo := MyGui.Add("Text", "xs+10 y+10", "Buttons below will alter GUI title with SendMessage")
TitleInfo.SetFont("cBlue s8")
SendBtn1 := MyGui.Add("Button", "xs+10 y+10", "Change Title")
SendBtn1.OnEvent("Click", ChangeTitle)
SendBtn2 := MyGui.Add("Button", "xs+120 yp", "Restore Title")
...
PostInfo := MyGui.Add("Text", "xs+10 y+10", "Run Notepad - Use PostMessage to show 'About'")
PostInfo.SetFont("cBlue s8")
PostBtn1 := MyGui.Add("Button", "xs+10 y+10", "Show Notepad 'About'")
...
; │  Add Picture  │
; └───────────────┘
MyPictureBtn := MyGui.Add("Button", "cBlue xp y+10", "Display a picture")
MyPictureBtn.SetFont("s10")
MyPictureBtn.OnEvent("Click", LoadPic)
SlugLine := MyGui.Add("Text", "cBlue w200 xp y800", "Pictures will display above")
SlugLine.SetFont("s10")

;#if WINDOWS
DestroyPictureBtn := MyGui.Add("Button", "cBlue xp y+10", "Destroy picture control")
DestroyPictureBtn.SetFont("s10")
...
gb1_TabThree := MyGui.Add("GroupBox", "Section x20 y50 w325 h875", "Tab Three - Group One")

	;Placeholder ThirdText1
ThirdText1 := MyGui.Add("Text", "cBlue xs+10 ys+20 h20 w200", "ListBox Test")
ThirdText1.SetFont("s10")
; ┌────────────────┐
; │  ListBox test  │
; └────────────────┘
...
; │  Multi-select  │
; └────────────────┘
ThirdText2 := MyGui.Add("Text", "xs+10 y+65 cBlue", "ListBox Test (Multi-Select)")
ThirdText2.SetFont("s10")
MyMultiLB := MyGui.Add("ListBox", "+Multi r5 w110 xs+10 y+10", ["Reactionary Red","Garish Green","Beastly Blue","Banal Black","Washed-out White"])
MyMultiLB.OnEvent("Change", MultiLBClicked)

; ┌─────────────┐
; │  Drop-Down  │
; └─────────────┘
ThirdText3 := MyGui.Add("Text", "xs+10 y+10 h20 w200 cBlue", "Drop-down List with 4 rows")
ThirdText3.SetFont("s10")
MyDDL := MyGui.Add("DropDownList", "xs+10 y+10 r4", ["Orange","Purple","Fuchsia","Lime","Aqua"])
MyDDL.OnEvent("Change", DDLClicked)

; ┌─────────────┐
; │  Combo Box  │
; └─────────────┘
ThirdText4 := MyGui.Add("Text", "xs+10 y+10 cBlue", "ComboBox with 3 rows")
ThirdText4.SetFont("s10")
MyCB := MyGui.Add("ComboBox", "xs+10 y+10 r3", ["Orange","Purple","Fuchsia","Lime","Aqua"])
CB_Button := MyGui.Add("Button", "h25 w80 xs+10 y+10", "CB Selection")
CB_AddBtn := MyGui.Add("Button", "h25 w80 xs+90 yp", "Add Yellow")
CB_Button.OnEvent("Click", CB_ButtonClicked)
CB_AddBtn.OnEvent("Click", AddYellow)
CB_DeleteBtn := MyGui.Add("Button", "h25 w80 xs+170 yp", "Del Yellow")
...
ThirdText5 := MyGui.Add("Text", "xs+10 y+10 cBlue", "Moving slider shows position below")
ThirdText5.SetFont("s10")
MySlider := MyGui.Add("Slider", "xs+10 y+10 +AltSubmit TickInterval10 Page10", 100)
MySlider.OnEvent("Change", SliderPos)
MySliderPos := MyGui.Add("Text", "xs+10 y+5","")
...
; │  Progress Bar  │
; └────────────────┘
ThirdText6 := MyGui.Add("Text", "xs+10 y+10 cBlue", "Progress bar - click buttons to move")
ThirdText6.SetFont("s10")
MyProgress := MyGui.Add("Progress", "xs+10 y+10 cRed BackgroundGreen Smooth", 50)
;#if WINDOWS
...
;#endif
Pbtn1 := MyGui.Add("Button", "xs+10 y+5", "Lower")
Pbtn1.SetFont("s8")
Pbtn2 := MyGui.Add("Button", "xs+100 yp", "Higher")
Pbtn2.SetFont("s8")
ProgressStatusText := MyGui.Add("Text", "x+5 yp cBlue", "Value: ")
ProgressStatusText.SetFont("s10")
...
; │  Date Time  │
; └─────────────┘
ThirdText7 := MyGui.Add("Text", "xs+10 y+15 cBlue", "DateTime Test")
ThirdText7.SetFont("s10")
MyDateTime := MyGui.Add("DateTime", "xs+10 y+5 w200", "LongDate")
MyDateTime.SetFont("s8")

; ┌────────────┐
; │  MonthCal  │
; └────────────┘
ThirdText8 := MyGui.Add("Text", "xs+10 y+5 cBlue", "MonthCal Test")
ThirdText8.SetFont("s10")
MyMonthCal := MyGui.Add("MonthCal")
MC_Btn := MyGui.Add("Button", "xs+10 y+5", "Change Cal Colors (not implemented)")
MC_Btn.SetFont("s10")
...
;MyGui.UseGroup()
Tab.UseTab("Third")
gb2_TabThree := MyGui.Add("GroupBox", "Section x350 y50 w325 h875", "Tab Three - Group Two")

; ┌────────────────┐
; │  Sliding text  │
; └────────────────┘

InfoText3 := MyGui.Add("Text", "xs+10 ys+20 w200", "Sliding text. Move Slider.")
InfoText3.SetFont("cBlue s8")
MyText := MyGui.Add("Text", "xs+10 y+10 w300 h30")
MyText.SetFont("cTeal Bold", "Consolas")
HwndMyText := MyText.Hwnd

MySlider2 := MyGui.Add("Slider", "Range0-80 +AltSubmit TickInterval10 Page10 ToolTip", 10)
MySlider2.Value := 10
mybtn := MyGui.Add("Button", "w100 cBlue", "Sliding Test")
mybtn.SetFont("s8")
mybtn.OnEvent("Click", STest)
FakeSep := MyGui.Add("Text", "xs+10 y+10", "__________________________________________________")
...
MyLinkText := MyGui.Add("Text", "xs+10 y+5", "Link test")
MyLinkText.SetFont("cBlue s8")
MyLink := MyGui.Add("Link", "xs+10 y+5", 'Click this <a href="https://www.autohotkey.com">link to AHK page</a>')

MyHkInfoText := MyGui.Add("Text", "xs+10 y+5 w200", "Define Hotkey test`nFocus Edit and click hotkey(s)")
MyHkInfoText.SetFont("cBlue s8")
MyHotkey := MyGui.Add("Hotkey", "xs+10 y+5")
MyHotkey.OnEvent("Change", UpdateHK)
MyHkText := MyGui.Add("Text", "xs+10 y+5 w50" , MyHotkey.Value)
;MyHkText2 := MyGui.Add("Text", "xs+10 y+5 w200 cRed", "NOTE: Combos w/Win not working.")
...
MyGui.Add("Text", "xs+5 y+5", "UpDown: Range 1-10, \ninc 1 (mouse 8), def 5.")
nud := MyGui.Add("UpDown", "xs+5 y+5 h25 vMyNud Range1-10", 5)
nud.OnEvent("Change", NudChange)

MyGui.Add("Text", "xs+5 y+5", "UpDown: Range -2000-2000, def 0,`ninc 100 (mouse 800), no separator.")
nud2 := MyGui.Add("UpDown", "xs+5 y+5 h20 vMyNud2 Range-2000-2000 0x80", 0) ;Removed Increment100
nud2.OnEvent("Change", NudChange)

MyGui.Add("Text", "xs+5 y+5", "UpDown: Range -1000-1000, def 0,`ninc 10 (mouse 80), hex.")
MyGui.Add("Edit", "xs+5 y+5")
nud3 := MyGui.Add("UpDown", "h20 vMyNud3 Range-1000-1000", 0) ;Removed Increment10 hex 0x80
nud3.OnEvent("Change", NudChange)

nudTxt := MyGui.Add("Text", "xs+5 y+5 w200", "Nud values:")
...
; │  Image copying tests  │
; └───────────────────────┘
gb1 := MyGui.Add("GroupBox", "Section x20 y50 w330 h400", "Group One")
;MyGui.UseGroup(gb1)
CpText := MyGui.Add("Text", "xs+10 ys+20", "gb1 - Image copying tests")
CpText.SetFont("s8 cBlue")
MyRE := MyGui.Add("Edit", "xs+10 y+10 w300 h100")
MySecondPic := LoadPicture(A_ScriptDir . A_DirSeparator . "Robin.png")
;CopyImageToClipboard("HBITMAP:" MySecondPic)
ShowBtn := MyGui.Add("Button", "xs+10 y+10", "Paste Pic")
...
LpText := MyGui.Add("Text", "xs+10 y+10", "Now copy a pic from a file.")
LpText.SetFont("s8 cBlue")
MyRE2 := MyGui.Add("Edit", "xs+10 y+10 w300 h100")
ShowBtn2 := MyGui.Add("Button", "xs+10 y+10", "Paste from file")
...
;MyGui.UseGroup()
Tab.UseTab("GroupBoxes")
gb3 := MyGui.Add("GroupBox", "Section x360 ys+0 w330 h400", "Group Three")
;MyGui.UseGroup(gb3)
MyGui.Add("Text", "xs+10 ys+20 w400", "Testing gb3")
...
;MyGui.UseGroup()
Tab.UseTab("GroupBoxes")
gb2 := MyGui.Add("GroupBox", "Section x20 y400 w330 h400", "Group Two")
;MyGui.UseGroup(gb2)
gb2Text := MyGui.Add("Text", "cBlue xs+10 ys+20 w200", "Testing various Send() types")
gb2Text.SetFont("s8")

gb2Edit := MyGui.Add("Edit", "xs+10 y+5 w300 h250")
gb2Btn1 := MyGui.Add("Button", "xs+10", "Notepad")
gb2Btn1.OnEvent("Click", SendToApp)
gb2Btn2 := MyGui.Add("Button", "xs+95 yp", "This Edit")
...
;MyGui.UseGroup()
Tab.UseTab("GroupBoxes")
gb4 := MyGui.Add("GroupBox", "Section x360 y400 w330 h400", "Group Four")
;MyGui.UseGroup(gb4)
MyGui.Add("Text", "xs+10 ys+20", "Testing gb4")
gb4Btn1 := MyGui.Add("Button", "cLime h20 w160", "Send to GB3")
gb4Btn1.SetFont("s14")
gb4Btn1.OnEvent("Click", SendToGB3)
gb4Btn2 := MyGui.Add("Button", "cLime x+5 yp h20 w100", "Clear GB3")
gb4Btn2.SetFont("s14")
gb4Btn2.OnEvent("Click", ClearGB3)
;MyGui.UseGroup()
Tab.UseTab("GroupBoxes")
belowText := MyGui.AddText("xm y+10 cBlue", "This should be below.")
belowText.SetFont("s14")
...
MenuHandler(Item, *) {
	...
	if (Item == "Script Icon")
		TraySetIcon(A_ScriptDir "\..\..\..\Keysharp.ico")
	else if (Item == "Suspend Icon")
		TraySetIcon(A_ScriptDir "\..\..\..\Keysharp_s.ico")
	else if (Item == "Pause Icon")
		TraySetIcon(A_ScriptDir "\..\..\..\Keysharp_p.ico")
	else if (Item == "System")
...
gb1_CZ := MyGui.Add("GroupBox", "Section x20 y50 w320 h875", "ControlZoo - Group One")
CZ_Text1 := MyGui.Add("Text", "xs+10 ys+20" , "Control Functions testing")
CZ_Text1.SetFont("s10 CBlue")
CZ_Text2 := MyGui.Add("Text", "xs+10 y+10 w300 h30 Border", "For the controls on this tab, we'll add, delete, click, focus and perform other control functions.")
CZ_Text2.SetFont("CTeal")

CZ_Text2a := MyGui.Add("Text", "xs+10 y+5", "ListBox control testing")
CZ_Text2a.SetFont("s8 CBlue")

CZ_ListBox := MyGui.Add("ListBox", "xs+10 y+5 h300 w160", ["Red","Green","Blue","Black","White", "Maroon"
	, "Purple", "Color de gos com fuig", "Weiß", "Amarillo", "красный"
	, "朱红"])

CZ_Text3 := MyGui.Add("Text", "xs+10 y+5", "Edit control testing")
CZ_Text3.SetFont("s8 CBlue")

CZ_Edit1 := MyGui.Add("Edit", "xs+10 y+5 w160 h100")
...
CZ_LbBtn1 := MyGui.Add("Button", "xs+180 w120 h25 ys+95", "Add Fuchsia")
CZ_LbBtn1.OnEvent("Click", AddFuchsia)
CZ_LbBtn2 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "Delete Fuchsia")
CZ_LbBtn2.OnEvent("Click", DeleteFuchsia)
CZ_LbBtn2.OnEvent("Focus", FuchsiaDeleteTrayTip)
CZ_LbBtn3 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "Purple (Index)")
CZ_LbBtn3.OnEvent("Click", ChooseIndex)
CZ_LbBtn4 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "красный (String)")
CZ_LbBtn4.OnEvent("Click", ChooseString)
CZ_LbBtn5 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "ControlGetChoice")
CZ_LbBtn5.OnEvent("Click", GetChoice)
CZ_LbBtn19 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "ControlGetIndex")
CZ_LbBtn19.OnEvent("Click", GetIndex)
CZ_LbBtn6 := MyGui.Add("Button", "xs+180 w120 h25 y+1", "ControlGetClassNN")
CZ_LbBtn6.OnEvent("Click", GetClassNN)

CZ_LbBtn7 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlGetEnabled")
CZ_LbBtn7.OnEvent("Click", GetEnabled)
CZ_LbBtn20 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlSetEnabled")
CZ_LbBtn20.OnEvent("Click", SetEnabled)
CZ_LbBtn8 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Disabled!")
CZ_LbBtn8.Enabled := False

CZ_LbBtn9 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlGetHwnd")
CZ_LbBtn9.OnEvent("Click", GetHwnd)

CZ_LbBtn10 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlGetText")
CZ_LbBtn10.OnEvent("Click", GetText)

CZ_LbBtn11 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlHide")
CZ_LbBtn11.OnEvent("Click", HideButton)

CZ_LbBtn12 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "ControlShow")
CZ_LbBtn12.OnEvent("Click", ShowButton)

CZ_LbBtn13 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Visible?")
CZ_LbBtn13.OnEvent("Click", IsItHidden)

CZ_LbBtn14 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Edit Column #")
CZ_LbBtn14.OnEvent("Click", GetCol)

CZ_LbBtn15 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Edit Line #")
CZ_LbBtn15.OnEvent("Click", GetLine)

CZ_LbBtn16 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Edit Line Text")
CZ_LbBtn16.OnEvent("Click", GetLineText)

CZ_LbBtn17 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Selected text")
CZ_LbBtn17.OnEvent("Click", GetSelectedText)

CZ_LbBtn18 := MyGui.Add("Button", "w120 xs+180 h25 y+1", "Edit Paste")
...
CZ_SeparatorText1 := MyGui.Add("Text", "xs+10 yp+8 w320", "ListView Content Tests")
CZ_SeparatorText1.SetFont("s8 CBlue")

LV2 := MyGui.Add("ListView", "r5 w300 xs+10 y+5", ["Name","Size (KB)"])

Loop Files, A_MyDocuments . A_DirSeparator . "*.*"
  LV2.Add(, A_LoopFileName, A_LoopFileSizeKB)

LV2_Btn1 := MyGui.Add("Button", "xs+10 y+5 w72 h25" ,"Selected")
LV2_Btn1.OnEvent("Click", LV_Selected)

LV2_Btn2 := MyGui.Add("Button", "xs+85 yp w72 h25" ,"Focused")
LV2_Btn2.OnEvent("Click", LV_Focused)

LV2_Btn3 := MyGui.Add("Button", "xs+160 yp wp+10 hp+10", "Column 1")
LV2_Btn3.OnEvent("Click", LV_Col1)

LV2_Btn4 := MyGui.Add("Button", "x+3 yp wp+10 hp+10", "Count")
LV2_Btn4.OnEvent("Click", LV_Count)

LV2_Btn5 := MyGui.Add("Button", "xs+10 yp+45 w100 h25", "Count Selected")
LV2_Btn5.OnEvent("Click", LV_CountSelected)

LV2_Btn6 := MyGui.Add("Button", "xs+113 yp w100 h25", "Row Focused")
LV2_Btn6.OnEvent("Click", LV_CountFocused)

LV2_Btn7 := MyGui.Add("Button", "xs+216 yp w100 h25", "Count Columns")
LV2_Btn7.OnEvent("Click", LV_CountCol)

;MyGui.UseGroup()
Tab.UseTab("ControlZoo")
gb2_CZ := MyGui.Add("GroupBox", "Section x350 y50 w370 h875", "ControlZoo - Group Two")
;MyGui.UseGroup(gb2_CZ)

;Reserved4 := MyGui.Add("Text", "x10 y20 w325", "Reserved for Future Testing")
;Reserved4.SetFont("s12 CBlue")
gb2_CZ_Text1 := MyGui.Add("Text", "xs+10 ys+20 w325", "ComboBox Control Tests")
gb2_CZ_Text1.SetFont("s8 cBlue")

gb2_CZ_CB := MyGui.Add("ComboBox", "xs+10 y+10 r5 Limit", ["Orange","Purple","Fuchsia","Lime","Aqua"])
gb2_CZ_Btn1 := MyGui.Add("Button", "xs+10 y+5 w80 h25", "Add White")
gb2_CZ_Btn1.OnEvent("Click", AddWhite2)
gb2_CZ_Btn2 := MyGui.Add("Button", "xs+90 yp w80 h25", "Delete White")
gb2_CZ_Btn2.OnEvent("Click", DeleteWhite2)
gb2_CZ_Btn3 := MyGui.Add("Button", "xs+170 yp w80 h25", "-> Purple")
gb2_CZ_Btn3.OnEvent("Click", ChooseString_CB)

gb2_CZ_Btn4 := MyGui.Add("Button", "xs+10 y+5 w200 h25", "Click Win+R, show dropdown")
gb2_CZ_Btn4.OnEvent("Click", Click_CB)

gb2_CZ_Btn5 := MyGui.Add("Button", "xs+10 y+5", "Show ListBox items")
...
gb2_CZ_Btn7 := MyGui.Add("Button", "xs+10 y+5", "Show ComboBox dropdown")
...
gb2_CZ_Text2 := MyGui.Add("Text", "xs+10 y+10 w325", "Move mouse to color. Press Ctrl+Alt+9.")
gb2_CZ_Text2.SetFont("s8 cBlue")

MyColorLabel := MyGui.Add("Text", "xs+10 y+10 w200", "Empty text below:")
MyColorText := MyGui.Add("Text", "w200 xs+10 y+10", "")

SecondGuiButton := MyGui.Add("Button", "xs+10 y+35", "Control Tests Redux")
SecondGuiButton.OnEvent("Click", SecondGUI)
FindEdit := MyGui.Add("Button", "xs+10 y+5", "Get Edit Hwnd")
FindEdit.OnEvent("Click", FindSecondGuiEdit)

ThirdGuiButton := MyGui.Add("Button", "xs+10 y+5", "'Find By' Tests")
ThirdGuiButton.OnEvent("Click", ThirdGUI)

MouseMoveButton := MyGui.Add("Button", "xs+10 y+5", "Mouse-moving tests")
MouseMoveButton.OnEvent("Click", MoveTheMouse)

;#if WINDOWS
AddMsgMonitorButton := MyGui.Add("Button", "xs+10 y+5", "Add msg mon for clicking in edit ctrl testing")
AddMsgMonitorButton.OnEvent("Click", AddMsgMonitor)

RemoveMsgMonitorButton := MyGui.Add("Button", "xs+10 y+5", "Remove msg mon")
RemoveMsgMonitorButton.OnEvent("Click", RemoveMsgMonitor)
;#endif

MinimizeAllButton := MyGui.Add("Button", "xs+10 y+5", "Minimize all")
MinimizeAllButton.OnEvent("Click", MinimizeAll)
UndoMinimizeAllButton := MyGui.Add("Button", "xs+10 y+5", "Undo minimize all")
UndoMinimizeAllButton.OnEvent("Click", UndoMinimizeAll)
MaximizeAllButton := MyGui.Add("Button", "xs+10 y+5", "Maximize all")
MaximizeAllButton.OnEvent("Click", MaximizeAll)
MoveAllButton := MyGui.Add("Button", "xs+10 y+5", "Move me")
...
TestTypesButton := MyGui.Add("Button", "xs+10", "Test types") ; Same, but for y.
...
CandyProgressBar := candygui.Add("Progress", "x15 y30 w436 h36 BackgroundSilver")
...
CandyProgress(*)
{
	...
	if (!WinExist("ahk_id" candygui.Hwnd))
	{
		candygui.Show("w485 h145")
		SetTimer(CandyTimer, 100)
	}
	else
		candygui.Close()
}
...
Gui2Edit := Gui2.Add("Edit", "x10 y+20 h400 w500 +Multi")
...
;MyGui.UseGroup()
Tab.UseTab("Send && Hotkey")
SectionTopText := MyGui.Add("Text", "x20 y50 w600", "This section is for testing the various Send() variants and the Hotkey method.")
SectionTopText.SetFont("cBlue s12")
MySendEdit := MyGui.Add("Edit", "x20 y+10 w700 h250", "The buttons below this Edit will use various Send() variants.`n")
BtnSend := MyGui.Add("Button", "x20 y+10 w80", "Send()")
...
MyScLabel := MyGui.Add("Text", "x20 y+10 w300", "Get screenclip at 100, 100, 200, 200`nSave to 'MyScreenClip.png' on Desktop`& display for 2 seconds.")
MyScLabel.SetFont("s8 cBlue")
MyScBtn := MyGui.Add("Button", "w200 h25 x20 y+10", "Press to get screenclip").OnEvent("Click", LoadSC)
; End of moving it
...
MyGui.Add("Text", "x10 y+20 w700", "_____________________________________________________________________________________________________________")
HotkeySectionTopText := MyGui.Add("Text", "x20 y+5 w600", "HOTKEY TESTS`nHold F1 to slow mouse, release to restore.")
HotkeySectionTopText.SetFont("cBlue s14")
FuncBtnOne := MyGui.Add("Button", "x20 y+5", "FuncObj Bind Tests")
FuncBtnOne.OnEvent("Click", DoTricks)

FuncBtnTwo := MyGui.Add("Button", "x140 yp", "RCtrl+RShift -> AltTab")
FuncBtnTwo.OnEvent("Click", StupidTrickTwo)

FuncBtnThree := MyGui.Add("Button", "x275 yp", "RCtrl+RShift -> AltTab`nHotkey Off")
FuncBtnThree.OnEvent("Click", StupidTrickThree)

FuncBtnFour := MyGui.Add("Button", "x410 yp", "RCtrl+RShift -> AltTab`nwith FuncObj")
FuncBtnFour.OnEvent("Click", FuncObjTest)

FuncBtnFive := MyGui.Add("Button", "x545 yp w150", "Toggle RCtrl+RShift ->`nAltTab Hotkey On or Off")
FuncBtnFive.OnEvent("Click", ToggleHotkey)

FuncBtnSix := MyGui.Add("Button", "x20 y+10 w150", "From .INI`nRCtrl+LShift -> AltTab")
FuncBtnSix.OnEvent("Click", GrabFromIni)

FuncBtnSeven := MyGui.Add("Button", "x170 yp w150", "Toggle Hotkey from .INI")
FuncBtnSeven.OnEvent("Click", ToggleFromIni)

F3HotkeyText := MyGui.Add("Text", "x20 y+30 w400", "Select files in explorer, press F3 to see names")
...
LoadPic(*) {
	...
	if (MySecondPic = "")
		MySecondPic := MyGui.Add("Picture", "x520 y650 w100 h-1 border", Icon2)
	else
...
ListBoxClicked(*) {
	...
	; MsgBox("Icon lives at " . A_ScriptDir "\..\..\..")
	MySB.SetIcon(A_ScriptDir "\..\..\..\Keysharp.ico")
...
hideCursorDllLabel := MyGui.Add("Text", "w400 x20 y50 cBlue","Press Win+C to hide the cursor, and press again to restore it.")
hideCursorDllLabel.SetFont("S10")

dllMsgBoxBtn := MyGui.Add("Button", "x20 y+10", "Dll MsgBox()")
dllMsgBoxBtn.OnEvent("Click", DllMsgBox)

dllMsgBoxBtn := MyGui.Add("Button", "x20 y+10", "Dll IsWindowVisible() (run notepad then click this)")
dllMsgBoxBtn.OnEvent("Click", DllIsWindowVisible)

dllWsprintfBtn := MyGui.Add("Button", "x20 y+10", "Dll wsprintf()")
dllWsprintfBtn.OnEvent("Click", DllWsprintf)

dllPerformanceCounterBtn := MyGui.Add("Button", "x20 y+10", "Dll QueryPerformanceCounter()")
dllPerformanceCounterBtn.OnEvent("Click", DllPerformanceCounter)

dllDllGetWindowRectBtn := MyGui.Add("Button", "x20 y+10", "Dll GetWindowRect()")
dllDllGetWindowRectBtn.OnEvent("Click", DllGetWindowRect)

dllDllFillRectBtn := MyGui.Add("Button", "x20 y+10", "Dll FillRect()")
dllDllFillRectBtn.OnEvent("Click", DllFillRect)

dllDllRemoveFromTaskbarBtn := MyGui.Add("Button", "x20 y+10", "Dll DeleteFromTaskbar() (clear for 3 seconds, then re-add)")
dllDllRemoveFromTaskbarBtn.OnEvent("Click", DllDeleteFromTaskbar)

comDllRemoveFromTaskbarBtn := MyGui.Add("Button", "x20 y+10", "COM DeleteFromTaskbar() (clear for 3 seconds, then re-add)")
comDllRemoveFromTaskbarBtn.OnEvent("Click", ComDeleteFromTaskbar)

comDllRunWordBtn := MyGui.Add("Button", "x20 y+10", "COM run MS Word")
comDllRunWordBtn.OnEvent("Click", ComRunWord)

comDllRunWordListenerBtn := MyGui.Add("Button", "x20 y+10", "COM run MS Word with event listener")
comDllRunWordListenerBtn.OnEvent("Click", ComRunWordEventListener)

comShellRunNotepad := MyGui.Add("Button", "x20 y+10", "COM shell Run() Notepad")
comShellRunNotepad.OnEvent("Click", ComRunNotepadShell)

comShellExecNotepad := MyGui.Add("Button", "x20 y+10", "COM shell Exec() Notepad")
comShellExecNotepad.OnEvent("Click", ComExecNotepadShell)

comFakeComCall := MyGui.Add("Button", "x20 y+10", "Fake COM call (hello)")
comFakeComCall.OnEvent("Click", FakeComCall)

activeXOdieText := MyGui.Add("Text", "x20 y+10 cBlue", "An animated Odie should appear below using ActiveX.")
activeXOdieText.SetFont("s10")

axPic := "http://www.animatedgif.net/cartoons/A_5odie_e0.gif"
axText := "mshtml:<img src='" . axPic . "' />"
activeXOdie := MyGui.AddActiveX("w100 h150 x20 y+10", axText)
...
txtMasterName := MyGui.Add("Text", "x20 y50 w400", "Master: " . SoundGetName())
...
txtMasterVolumeSlider := MyGui.Add("Text", "x20 y+10 cBlue", "Moving slider sets master volume")
txtMasterVolumeSlider.SetFont("s10")
...
txtAdjMasterVolumeSlider := MyGui.Add("Text", "x20 y+10 cBlue", "Moving slider adjusts master volume")
txtAdjMasterVolumeSlider.SetFont("s10")
